...
% manuscript for 8-second sliding window size and 1 second step size.
%
...
save('miscellaneous/ws_results_BLP_ec_revised.mat', 'chanlocs', 'rsnlab', 'nch', 'nrsn',...
...
writetable(table_export_blp_exploratory,'miscellaneous/table_blp_exploratory.xlsx')
writetable(table_export_blp_rsn,'miscellaneous/table_blp_rsn.xlsx')
...
writetable(table_panss_rsn_blp_all_ec,'miscellaneous/table_panss_corr_blp_rsn.xlsx')

%% saving results
save('miscellaneous/ws_correlations_BLP_ec_revised.mat', 'chanlocs', 'rsnlab', 'nch', 'nrsn',...
