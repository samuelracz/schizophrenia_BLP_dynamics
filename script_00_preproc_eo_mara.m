...
% 'fnames_times_eo.mat'. In the article, we used a zero-phase Butterworth
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
path_to_raw_eeg = 'sch_resting_64ch_eo';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% define output path to save pre-processed EEG and MARA statistics %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
path_to_pre_processed_eeg = 'data_eo_mara_avg_256Hz';
path_to_mara_statistics = 'dataset_eo_MARA';

for subj = 1:ns
    %% load data
    subjID = subj_list{subj};
    fname_in = ['/sch_' subjID '_eo.dat'];
   ...
   %% select channels
    ...
    EEG = pop_select( EEG, 'time',[fnames_eo(subj).start fnames_eo(subj).stop-1/1000] );
    EEG = eeg_checkset( EEG );
